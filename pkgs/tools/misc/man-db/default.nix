...
stdenv.mkDerivation rec {
  ...
  postPatch = ''
    ...
    echo "MANPATH_MAP	/data/data/com.termux/files/nix/var/nix/profiles/default/bin	/data/data/com.termux/files/nix/var/nix/profiles/default/share/man" >> src/man_db.conf.in

    # Add mandb locations for the above
    echo "MANDB_MAP	/data/data/com.termux/files/nix/var/nix/profiles/default/share/man	/var/cache/man/nixpkgs" >> src/man_db.conf.in
  '';
