...
stdenv.mkDerivation (finalAttrs: {
  ...
  doCheck =
    ...
    # x86_64-unknown-linux-musl-ld: /data/data/com.termux/files/nix/store/h9gcvnp90mpniyx2v0d0p3s06hkx1v2p-x86_64-unknown-linux-musl-gcc-13.3.0/lib/gcc/x86_64-unknown-linux-musl/13.3.0/crtbeginT.o: relocation R_X86_64_32 against hidden symbol `__TMC_END__' can not be used when making a shared object
