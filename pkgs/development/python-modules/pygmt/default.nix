...
buildPythonPackage rec {
  ...
  meta = with lib; {
    ...
    # pygmt.exceptions.GMTCLibNotFoundError: Error loading the GMT shared library '/data/data/com.termux/files/nix/store/r3xnnqgl89vrnq0kzxx0bmjwzks45mz8-gmt-6.1.1/lib/libgmt.dylib'
