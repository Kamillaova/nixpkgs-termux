...
stdenv.mkDerivation rec {
  ...
  # RPATH of binary /data/data/com.termux/files/nix/store/.../lib64/games/speed-dreams-2/drivers/shadow_sc/shadow_sc.so contains a forbidden reference to /build/
