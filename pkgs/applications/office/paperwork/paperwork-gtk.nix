...
python3Packages.buildPythonApplication rec {
  ...
  postInstall = ''
    ...
    # /data/data/com.termux/files/nix/store/3n5lz6y8k9yks76f0nar3smc8djan3xr-paperwork-2.0.2/lib/python3.8/site-packages/paperwork_gtk/icon/out/paperwork_128.png.
