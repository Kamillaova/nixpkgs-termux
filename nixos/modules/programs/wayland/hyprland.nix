  ...
  config = lib.mkIf cfg.enable (lib.mkMerge [
    {
      ...
      systemd = lib.mkIf cfg.systemd.setPath.enable {
        user.extraConfig = ''
          DefaultEnvironment="PATH=/run/wrappers/bin:/etc/profiles/per-user/%u/bin:/data/data/com.termux/files/nix/var/nix/profiles/default/bin:/run/current-system/sw/bin:$PATH"
        '';
      };
    }
