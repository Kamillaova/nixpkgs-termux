  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.services.gogs = {
      ...
      in ''
        ...
        if [ "$HOOKS" ]
        then
          sed -ri 's,/data/data/com.termux/files/nix/store/[a-z0-9.-]+/bin/gogs,${pkgs.gogs}/bin/gogs,g' $HOOKS
          sed -ri 's,/data/data/com.termux/files/nix/store/[a-z0-9.-]+/bin/env,${pkgs.coreutils}/bin/env,g' $HOOKS
          sed -ri 's,/data/data/com.termux/files/nix/store/[a-z0-9.-]+/bin/bash,${pkgs.bash}/bin/bash,g' $HOOKS
          sed -ri 's,/data/data/com.termux/files/nix/store/[a-z0-9.-]+/bin/perl,${pkgs.perl}/bin/perl,g' $HOOKS
        fi
      '';
