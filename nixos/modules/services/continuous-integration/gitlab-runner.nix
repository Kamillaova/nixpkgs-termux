      ...
      example = literalExpression ''
        {
          ...
          nix = {
            ...
            dockerImage = "alpine";
            dockerVolumes = [
              "/data/data/com.termux/files/nix/store:/data/data/com.termux/files/nix/store:ro"
              "/data/data/com.termux/files/nix/var/nix/db:/data/data/com.termux/files/nix/var/nix/db:ro"
              "/data/data/com.termux/files/nix/var/nix/daemon-socket:/data/data/com.termux/files/nix/var/nix/daemon-socket:ro"
            ];
            dockerDisableCache = true;
            preBuildScript = pkgs.writeScript "setup-container" '''
              mkdir -p -m 0755 /data/data/com.termux/files/nix/var/log/nix/drvs
              mkdir -p -m 0755 /data/data/com.termux/files/nix/var/nix/gcroots
              mkdir -p -m 0755 /data/data/com.termux/files/nix/var/nix/profiles
              mkdir -p -m 0755 /data/data/com.termux/files/nix/var/nix/temproots
              mkdir -p -m 0755 /data/data/com.termux/files/nix/var/nix/userpool
              mkdir -p -m 1777 /data/data/com.termux/files/nix/var/nix/gcroots/per-user
              mkdir -p -m 1777 /data/data/com.termux/files/nix/var/nix/profiles/per-user
              mkdir -p -m 0755 /data/data/com.termux/files/nix/var/nix/profiles/per-user/root
            ...
            environmentVariables = {
              ...
              USER = "root";
              NIX_REMOTE = "daemon";
              PATH = "/data/data/com.termux/files/nix/var/nix/profiles/default/bin:/data/data/com.termux/files/nix/var/nix/profiles/default/sbin:/bin:/sbin:/usr/bin:/usr/sbin";
              NIX_SSL_CERT_FILE = "/data/data/com.termux/files/nix/var/nix/profiles/default/etc/ssl/certs/ca-bundle.crt";
            };
            tagList = [ "nix" ];
          };
