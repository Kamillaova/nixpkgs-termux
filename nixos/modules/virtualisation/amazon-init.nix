...
let
  ...
  script = ''
    ...
    export NIX_PATH=nixpkgs=/data/data/com.termux/files/nix/var/nix/profiles/per-user/root/channels/nixos:nixos-config=/etc/nixos/configuration.nix:/data/data/com.termux/files/nix/var/nix/profiles/per-user/root/channels
